...
pub struct RawImage {
  ...
  /// type of encoding, used to encode again
...
impl RawImage {
  #[doc(hidden)] pub fn new(camera: Camera, width: usize, height: usize, wb_coeffs: [f32;4], offset: usize, bps: usize, encoding: Encoding, image: Vec<u16>, dummy: bool) -> RawImage {
